programa
{
	...
	funcao inteiro cenario(logico nv1, logico nv6, logico nv8,logico nv9,logico nv11,inteiro posY,inteiro posX, inteiro VelDoPerssonagem,inteiro retorno) {
		se (nv1 == verdadeiro) {
			...
			g.desenhar_retangulo(330, 320, 25, 25, falso, verdadeiro)
			g.desenhar_retangulo(310, 330, 10, 10, falso, verdadeiro)
			g.desenhar_retangulo(915, 620, 20, 35, falso, verdadeiro)
	...
	funcao SpawnED(logico ed,inteiro X, inteiro Y) {
		se (ed == verdadeiro) {
			g.definir_cor(g.criar_cor(174, 26, 247))
			g.desenhar_elipse(X, Y, 25, 25, verdadeiro)
		}
	}
	//Esfera
	...
	funcao inteiro pausa(inteiro pause,inteiro opcao) {
		...
		enquanto (pause == 1) {
			...
			se (t.tecla_pressionada(38)) {
				opcao++
				u.aguarde(200)
			} senao se (t.tecla_pressionada(40)) {
				opcao--
				u.aguarde(200)
			}
			se (opcao > 2) {
 ...
 * 
 * @POSICAO-CURSOR = 139; 
 * @DOBRAMENTO-CODIGO = [1595, 1684, 1694, 1702, 1710, 1771, 1781, 1789, 1797, 1860, 1870, 1878, 1886];
 * @PONTOS-DE-PARADA = ;
