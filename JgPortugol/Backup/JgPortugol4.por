programa
{
	...
	funcao IniciarJogo() {
		...
		enquanto (jg == verdadeiro) {
			...
			se (EFormacao == 1) {
				...
				esferaDoDev(20, 50)
				SpawnEsfera(Esfera[0],20, 50)
				esferaDoDev(820, 150)
				SpawnEsfera(Esfera[1],820, 150)
				esferaDoDev(1450, 750)
				SpawnEsfera(Esfera[2],1450, 750)
				esferaDoDev(150, 850)
				SpawnEsfera(Esfera[3],150, 850)
				esferaDoDev(1235, 50)
				SpawnEsfera(Esfera[4],1235, 50)
			...
			se (EFormacao == 2) {
				...
				esferaDoDev(650,50)
				SpawnEsfera(Esfera[0], 650, 50)
				esferaDoDev(420, 150)
				SpawnEsfera(Esfera[1], 420, 150)
				esferaDoDev(725, 750)
				SpawnEsfera(Esfera[2], 725, 750)
				esferaDoDev(1400, 850)
				SpawnEsfera(Esfera[3], 1400, 850)
				esferaDoDev(250, 50)
				SpawnEsfera(Esfera[4], 250, 50)
			...
			se (EFormacao == 3) {
				...
				esferaDoDev(140, 140)
				SpawnEsfera(Esfera[0], 140, 140)
				esferaDoDev(1370, 125)
				SpawnEsfera(Esfera[1], 1370, 125)
				esferaDoDev(1250, 650)
				SpawnEsfera(Esfera[2], 1250, 650)
				esferaDoDev(1240, 840)
				SpawnEsfera(Esfera[3], 1240, 840)
				esferaDoDev(40, 830)
				SpawnEsfera(Esfera[4], 40, 830)
			...
			se (EFormacao == 4) {
				...
				SpawnEsfera(Esfera[1], 1150, 325)
				esferaDoDev(1400, 800)
				SpawnEsfera(Esfera[2], 1400, 800)
				esferaDoDev(1240, 840)
				SpawnEsfera(Esfera[3], 1240, 840)
				esferaDoDev(40, 830)
				SpawnEsfera(Esfera[4], 40, 830)
			...
			se (EFormacao == 5) {
				...
				esferaDoDev(290, 570)
				SpawnEsfera(Esfera[0], 290, 570)
				esferaDoDev(315, 150)
				SpawnEsfera(Esfera[1], 315, 150)
				esferaDoDev(750, 160)
				SpawnEsfera(Esfera[2], 750, 160)
				esferaDoDev(1240, 40)
				SpawnEsfera(Esfera[3], 1240, 40)
				esferaDoDev(1260, 610)
				SpawnEsfera(Esfera[4], 1260, 610)
			...
			se (EFormacao == 6) {
				...
				esferaDoDev(150, 300)
				SpawnEsfera(Esfera[0], 150, 300)
				esferaDoDev(450, 600)
				SpawnEsfera(Esfera[1], 450, 600)
				esferaDoDev(720, 470)
				SpawnEsfera(Esfera[2], 720, 470)
				esferaDoDev(1050, 250)
				SpawnEsfera(Esfera[3], 1050, 250)
				esferaDoDev(1240, 50)
				SpawnEsfera(Esfera[4], 1240, 50)
			...
			se (EFormacao == 7) {
				...
				SpawnEsfera(Esfera[0], 20, 50)
				esferaDoDev(140, 140)
				SpawnEsfera(Esfera[1], 140, 140)
				esferaDoDev(1370, 125)
				SpawnEsfera(Esfera[2], 1370, 125)
				esferaDoDev(290, 570)
				SpawnEsfera(Esfera[3], 290, 570)
				esferaDoDev(650,50)
				SpawnEsfera(Esfera[4], 650, 50)
			...
			se (EFormacao == 8) {
				...
				SpawnEsfera(Esfera[0], 20, 50)
				esferaDoDev(1250, 225)
				SpawnEsfera(Esfera[1], 1250, 225)
				esferaDoDev(1440, 200)
				SpawnEsfera(Esfera[2], 1440, 200)
				esferaDoDev(150, 850)
				SpawnEsfera(Esfera[3], 150, 850)
				esferaDoDev(1235, 50)
				SpawnEsfera(Esfera[4], 1235, 50)
			...
			se (EFormacao == 9) {
				...
				esferaDoDev(240,150)
				SpawnEsfera(Esfera[0], 240, 150)
				esferaDoDev(730, 360)
				SpawnEsfera(Esfera[1], 730, 360)
				esferaDoDev(350, 470)
				SpawnEsfera(Esfera[2], 350, 470)
				esferaDoDev(1110,470)
				SpawnEsfera(Esfera[3], 1110, 470)
				esferaDoDev(1110,770)
				SpawnEsfera(Esfera[4], 1110, 770)
			...
			// Controla o FPS
          	...
          	se (t.tecla_pressionada(27) e pause == falso) {
          		pause = verdadeiro
          		u.aguarde(200)
          		pause = pausa(pause)
          		u.aguarde(200)
	...
	//Esfera
	funcao SpawnEsfera(logico Esfera, inteiro X, inteiro Y) {
	...
	funcao logico pausa(logico pause) {
		inteiro opcao = 0
		enquanto (pause == verdadeiro) {
			g.definir_cor(20)
			...
			se(t.tecla_pressionada(27) ou t.tecla_pressionada(10)) {
				pause = falso
			}
	...
	funcao inteiro gameover(inteiro opcao) {
		...
		enquanto (go == verdadeiro) {
			...
			se (opcao == 1) {
				g.desenhar_texto(660, 410, "REINICIAR")
			} senao {
				g.desenhar_texto(660, 410, "MENU")
			}
 ...
 * 
 * @POSICAO-CURSOR = 61130; 
 * @DOBRAMENTO-CODIGO = [1788, 1876, 1886, 1894, 1902, 1962, 1972, 1980, 1988, 2050, 2060, 2068, 2076];
 * @PONTOS-DE-PARADA = ;
