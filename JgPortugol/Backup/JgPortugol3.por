programa
{
		...
		enquanto (jg == verdadeiro) {
			...
			se (cena == 1) {
				se (nivel > 9 e nivel % 10 < 1) {
					...
					se (nivel >= 5) {
						posX = cenario(verdadeiro, falso, falso, verdadeiro, falso, posY, posX, VelDoPerssonagem, 0)
						posY = cenario(verdadeiro, falso, falso, verdadeiro, falso, posY, posX, VelDoPerssonagem, 1)
					}
					se (nivel >= 8) {
						posX = cenario(verdadeiro, falso, falso, falso, falso, posY, posX, VelDoPerssonagem, 0)
						posY = cenario(verdadeiro, falso, falso, falso, falso, posY, posX, VelDoPerssonagem, 1)
	...
	funcao inteiro valor2(inteiro Valor) {
		retorne Valor
	}
}
/* $$$ Portugol Studio $$$ 
 ...
 * 
 * @POSICAO-CURSOR = 2641; 
 * @DOBRAMENTO-CODIGO = [1688, 1698, 1706, 1714, 1724, 1728, 1732, 1736, 1781, 1791, 1799, 1807, 1817, 1821, 1825, 1829, 1872, 1882, 1890, 1898, 1908, 1912, 1916, 1920, 1965, 1975, 1983, 1991, 2001, 2005, 2009, 2013];
 * @PONTOS-DE-PARADA = ;
