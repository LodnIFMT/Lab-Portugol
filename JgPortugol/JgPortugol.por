programa
{
	...
	funcao IniciarJogo() {
		...
		inteiro telaLargura, telaAltura, posY, posX, VelDoPerssonagem, cena, esferas, nivel, EsferasColetadas, 
			EFormacao, frames, segundos, FSBonus, FaseB, FB
		inteiro tempoAnterior = u.tempo_decorrido()
		logico Esfera[5] = {verdadeiro, verdadeiro, verdadeiro, verdadeiro, verdadeiro}
		logico ed[3] = {verdadeiro, verdadeiro, verdadeiro}
		logico ec[5] = {falso, falso, falso, falso, falso}
		logico edc[3] = {falso, falso, falso}
		frames = 60
		segundos = 0
		jg = verdadeiro
		telaAltura = 900
		...
		//Fase Bonus
		FormacaoBonus(posX, posY, EsferasColetadas, esferas, FaseB, nivel, EFormacao, FB)
			
		// Controla o FPS
       	inteiro tempoAgora = u.tempo_decorrido()
		enquanto(tempoAgora - tempoAnterior < 1000/30) {
	...
	funcao inteiro FormacaoBonus(
		inteiro posX, inteiro posY,inteiro EsferasColetadas, inteiro esferas, 
		inteiro FaseB,inteiro nivel, inteiro EFormacao, inteiro Inicio
		) {
			inteiro Fase = 0
			logico Esfera[5]
			logico ec[5]
 ...
 * 
 * @POSICAO-CURSOR = 46860; 
 * @DOBRAMENTO-CODIGO = [8, 17, 2227, 2256, 2332, 2336, 2342];
 * @PONTOS-DE-PARADA = ;
